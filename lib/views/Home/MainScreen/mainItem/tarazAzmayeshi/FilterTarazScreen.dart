...
class FilterTarazScreen extends StatelessWidget {
  const FilterTarazScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    FilterTarazController controller = Get.put(FilterTarazController());
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Color(AppColor.primaryColor),
        title: Text("فیلتر " + AppString.tarazAzmayeshi),
      ),
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            MaterialButton(
              onPressed: () {
                controller.getTaraz(convertJtoGDate(
      ...
      body: Column(
        children: [
          ...
          ListTile(title: Text("نمایش حساب ها با گردش صفر"),leading:Obx((){return Checkbox(activeColor: Color(AppColor.primaryColor),value:controller.isChecked.value,onChanged: (value){controller.isChecked.value=value!;});}),)
  ...
  void showCalender(BuildContext context,
      FilterTarazController controller, int num) async {
    /////////////////////////Example 1////////////////////////////
