...
class SoodVzianDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
          ...
          body: OrientationBuilder(builder:(context , orientation)=> orientation == Orientation.portrait ? _portraitView(wi, he  ,Get.find<SoodVzianController>() ) :
          _landScapeView( Get.find<SoodVzianController>()) ),

    );

  }
  Widget _portraitView(double wi , double he  ,SoodVzianController soodVzianController){
